...
if(1):
    for ind,i in enumerate(q):
        data = pd.read_csv(pwd+'/outputs/singletobinary/fig2_singletobinary_'+str(ind)+'_data_0.100_15.000_10.000_1.047_0.010_'+str(i)+'00_0.400.csv')
        sin_data = pd.read_csv(pwd+'/outputs/singletobinary/fig2_singletobinary_'+str(ind)+'_output_(single).csv')
        bin_data = pd.read_csv(pwd+'/outputs/singletobinary/fig2_singletobinary_'+str(ind)+'_output_(binary).csv')
        mi_data = pd.read_csv(pwd+'/outputs/singletobinary/fig2_singletobinary_'+str(ind)+'_mtrace.csv')
    ...
    table.to_csv('single_to_binary_model_test_probabilities_fig2.csv',index=False)
    table2.to_csv('single_to_binary_parameter_estimates_fig2.csv',index=False)
